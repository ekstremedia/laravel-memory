...
<div class="wrapper w-60 bg-indigo-900/40 h-screen flex">
    <div class="sidebar flex flex-col  items-center w-full justify-start" data-color="brown" data-active-color="danger">
